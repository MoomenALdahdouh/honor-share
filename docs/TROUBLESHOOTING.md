...
The app will say Wi-Fi is turned off. Turn Wi-Fi on. Internet is not required.

## Bluetooth disabled

Bluetooth is not required. This product uses the local network, not Nearby Connections.
...
Nearby access is required to find the Mac. Use Allow access, or Open Settings if you denied it. The app will not loop the system dialog.

## Transfer interrupted

You will see “Connection lost”. Completed files stay. The unfinished file is deleted (temp only). Retry the transfer.

## Disk full

Receiving is refused before it starts if there is not enough space. Free space and try again.

## Codes do not match

Do not tap Connect. Cancel and reconnect next to each other. A mismatch means you are not talking to the device you think you are.
